...
public class DoublingReadableRangeBuilderTest {
  @Test
  public void toRange_singleRange_getOneRange() {
    var builder = new DoublingReadableRangeBuilder(List.of(1, 2, 3));
  ...
  public void toRange_singleElement_getOneElement() {
    var builder = new DoublingReadableRangeBuilder(List.of(1));
    var ranges = builder.toRange();
    assertEquals(1, ranges.size());
  ...
  public void toRange_twoRanges_getTheRangeInOutput() {
    var builder = new DoublingReadableRangeBuilder(List.of(1, 2, 3, 7, 8, 9));
    var ranges = builder.toRange();
  ...
  public void toRange_threeRangeMidSingle_getThreeRanges() {
    var builder = new DoublingReadableRangeBuilder(List.of(1, 2, 3, 5, 7, 8, 9));
    var ranges = builder.toRange();
  ...
  public void toRange_threeRangeOnlyMultiRange_getThreeRanges() {
    var builder = new DoublingReadableRangeBuilder(List.of(1, 2, 3, 5, 6, 7, 8, 9, 100, 101));
    var ranges = builder.toRange();
    assertEquals(3, ranges.size());
    assertEquals("[1-3]", ranges.get(0));
  ...
  public void toRange_largeRange_expectedOutput() {
    var builder =
        new DoublingReadableRangeBuilder(
            List.of(
